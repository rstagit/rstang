...
object AppConfig {
    ...
    const val PREF_FRAGMENT_AUTO_SETTING = "pref_fragment_auto_setting"
    const val PREF_AUTO_CONNECT_BEST_PING = "pref_auto_connect_best_ping"
    const val PREF_RSTA_SPOOF_CONNECT_IP = "pref_rsta_spoof_connect_ip"
    const val PREF_RSTA_SPOOF_CONNECT_PORT = "pref_rsta_spoof_connect_port"
    const val PREF_RSTA_SPOOF_FAKE_SNI = "pref_rsta_spoof_fake_sni"
    const val PREF_RSTA_SPOOF_METHOD = "pref_rsta_spoof_method"
    ...
    const val RSTA_SPOOF_LISTEN_PORT = 40443
