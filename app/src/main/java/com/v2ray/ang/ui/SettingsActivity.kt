...
class SettingsActivity : BaseActivity() {
    ...
    class SettingsFragment : PreferenceFragmentCompat() {
        ...
        private val fragmentAutoSetting by lazy { findPreference<CheckBoxPreference>(AppConfig.PREF_FRAGMENT_AUTO_SETTING) }
        ...
        override fun onCreatePreferences(bundle: Bundle?, s: String?) {
            ...
            fragmentAutoSetting?.setOnPreferenceChangeListener { _, newValue ->
                updateFragmentAutoSetting(newValue as Boolean)
                true
            }
        ...
        private fun updateFragmentAutoSetting(enabled: Boolean) {
            ...
            if (enabled) {
                ...
                fragmentLength?.text = "1-1"
                fragmentInterval?.text = "0-0"
                fragmentPackets?.value = "tlshello"
                updateFragment(true)
            }
        }
